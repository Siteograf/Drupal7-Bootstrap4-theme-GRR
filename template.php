 ...
 */
function bootstrap_grr_css_alter(&$css)
{
    $theme_path = drupal_get_path('theme', 'bootstrap_grr');

    if ($bootstrap_cdn = theme_get_setting('bootstrap_grr_cdn')) {
        // Add CDN.
        if ($bootswatch = theme_get_setting('bootstrap_grr_bootswatch')) {
    ...
    if ($font_awesome = theme_get_setting('bootstrap_grr_font_awesome')) {
 ...
 */
//function bootstrap_grr_js_alter(&$js) {
//  if (theme_get_setting('bootstrap_grr_cdn')) {
//    $cdn = '//netdna.bootstrapcdn.com/bootstrap/' . theme_get_setting('bootstrap_grr_cdn')  . '/js/bootstrap.min.js';
...
//    $js[$cdn]['weight'] = -100;
//  }
//  if('fixed-top' == theme_get_setting('bootstrap_grr_navbar_position')){
 ...
 */
function bootstrap_grr_preprocess_html(&$variables)
{
    if ($navbar_position = theme_get_setting('bootstrap_grr_navbar_position')) {
    ...
    /*    if($navbar_position == 'fixed-top' && user_access('access administration bar') && !admin_bar_suppress(FALSE) && !$config->get('position_fixed') ){
          drupal_add_js(drupal_get_path('theme', 'bootstrap_grr') . '/js/navbar-fixed-top.js');
        }
        if($navbar_position == 'static-top'){
          drupal_add_js(drupal_get_path('theme', 'bootstrap_grr') . '/js/navbar-static-top.js');
        }*/
 ...
 */
function bootstrap_grr_preprocess_page(&$variables)
{
    ...
    $variables['container_class'] = theme_get_setting('bootstrap_grr_container');

    if (theme_get_setting('bootstrap_grr_navbar_inverse')) {
 ...
 * @see page.tpl.php
 */
function bootstrap_grr_process_page(&$variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_fieldset($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_button($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_email($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_textfield($variables)
{
    $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function bootstrap_grr_textarea($variables)
{
    $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function bootstrap_grr_form_element($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_password($variables)
{
    $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function bootstrap_grr_search($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_select($variables)
{
 ...
 */
function bootstrap_grr_preprocess_table(&$variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_user_permission_description($variables)
{
    $description = array();
 ...
 * @ingroup themeable
 */
function bootstrap_grr_admin_block($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_system_admin_index($variables)
{
 ...
 * @ingroup themeable
 */
function bootstrap_grr_admin_page($variables)
{
 ...
 */
function bootstrap_grr_menu_local_tasks(&$variables)
{
    $output = '';
 ...
 */
function bootstrap_grr_links__dropbutton($menu)
{
 ...
 */
function bootstrap_grr_menu_local_actions(&$variables)
{
 ...
 */
function bootstrap_grr_breadcrumb($variables)
{
 ...
 */
function bootstrap_grr_preprocess_breadcrumb(&$variables)
{
    $breadcrumb = &$variables['breadcrumb'];

    // Optionally get rid of the homepage link.
    $show_breadcrumb_home = theme_get_setting('bootstrap_grr_breadcrumb_home');
    if (!$show_breadcrumb_home) {
        array_shift($breadcrumb);
    }
    if (theme_get_setting('bootstrap_grr_breadcrumb_title') && !empty($breadcrumb)) {
        $item = menu_get_item();
 ...
 * @ingroup themeable
 */
function bootstrap_grr_container($variables)
{
 ...
 */
function bootstrap_grr_preprocess_views_view_table(&$variables)
{
 ...
 */
function bootstrap_grr_form_alter(array &$form, array &$form_state = array(), $form_id = NULL)
{
    if ($form_id) {
 ...
 */
function bootstrap_grr_node_add_list($variables)
{
 ...
 */
function bootstrap_grr_admin_block_content($variables)
{
    return bootstrap_grr_node_add_list($variables);
}
 ...
 */
function bootstrap_grr_preprocess_user_picture(&$variables)
{
    // print_r($variables);
 ...
 */
function bootstrap_grr_preprocess_comment(&$variables)
{
//  print_r($variables);
    if (theme_get_setting('bootstrap_grr_datetime')) {
 ...
 */
function bootstrap_grr_preprocess_node(&$variables)
{
    if (theme_get_setting('bootstrap_grr_datetime')) {
 ...
 */
function bootstrap_grr_status_messages($variables)
{
 ...
 */
function bootstrap_grr_menu_link(array $variables)
{
    $element = $variables['element'];
    $sub_menu = '';
...
function bootstrap_grr_menu_tree__system_primary_menu($variables)
{
    $navbar_menu_position = theme_get_setting('bootstrap_grr_navbar_menu_position');
    return '<ul class="menu nav navbar-nav ' . $navbar_menu_position . ' primary-menu">' . $variables['tree'] . '</ul>';
}

function bootstrap_grr_menu_tree__system_secondary_menu($variables)
{
